...
# -*- coding: utf-8 -*-
#
# vizproo documentation build configuration file
#
...
_version_py = os.path.join(repo, 'vizproo', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'vizproo.tex', 'vizproo Documentation',
     'MATIUS', 'manual'),
]
